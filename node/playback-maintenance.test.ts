...
function renderer(options: { readOnly?: boolean; saving?: boolean; regenerating?: boolean } = {}) {
...
test('read-only and busy catalogue actions cannot change Last Played or report a successful reset', () => {
  for (const options of [{ readOnly: true }, { saving: true }, { regenerating: true }]) {
